...
class MySVM:
    _filesFolder = "./filesFolds-SVMbigrams"
    _memmapFolder = "./memmapFolds-SVMbigrams"
    _tmpFolder = "./tmpFolds-SVMbigrams"
    ...
    def __init__(self, fold=0, tasks=['sede1', 'sede12', 'morfo1', 'morfo2'], corpusFolder="corpusLSTM_ICDO3", foldsFolder="folds10"):
        self._tasks = tasks
    ...
    def evaluate(self):
        ...
        for task in self._tasks:
            ...
            print(task)
            prediction = {}
            yp[task] = self.model[task].decision_function(self.XTest[task])
