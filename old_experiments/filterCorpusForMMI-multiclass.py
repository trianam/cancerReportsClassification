...
fileOutCorpus = outDir+"/corpusFiltered-multiclass.p"
fileOutCorpusBalanced = outDir+"/corpusFiltered-multiclass-noRare.p"
...
for i in range(len(text)):
    if y[i] in possibleValues:
        newCorpus['text'].append(text[i])
        newCorpus[balanceKey].append(y[i])
