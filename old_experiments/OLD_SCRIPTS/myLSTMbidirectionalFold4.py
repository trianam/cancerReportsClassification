...
class MyLSTM:
    _filesFolder = "./filesFolds-LSTMbidirectional4"
    _memmapFolder = "./memmapFolds-LSTMbidirectional4"
    _tmpFolder = "./tmpFolds-LSTMbidirectional4"
    ...
    def __init__(self, fold=0, tasks=['sede1', 'sede12', 'morfo1', 'morfo2'], corpusFolder="corpusLSTM_ICDO3", foldsFolder="folds10", fileVectors="vectors.txt", phraseLen = 200, lstmCells=150, learningRate=0.01, dropout=0.3, patience=2, batchSize=65, epochs=100):
        self._tasks = tasks
