...
class MySVM:
    ...
    #_tasks = ['sede1']
    _filesFolder = "./filesSVM2"
    _memmapFolder = "./memmapSVM"
    ...
    def extractData(self):
        ...
        if useGlove:
            ...
            #vectorizer = TfidfVectorizer(min_df=3, max_df=0.5, strip_accents='unicode')
            vectorizer = TfidfVectorizer(min_df=3, max_df=0.3, strip_accents='unicode')
            vectorizer.fit(text)
