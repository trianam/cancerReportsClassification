...
class MyLSTM:
    _filesFolder = "./filesFolds-LSTMbidirectional3"
    _memmapFolder = "./memmapFolds-LSTMbidirectional3"
    _tmpFolder = "./tmpFolds-LSTMbidirectional3"
    ...
    def __init__(self, fold=0, tasks=['sede1', 'sede12', 'morfo1', 'morfo2'], corpusFolder="corpusLSTM_ICDO3", foldsFolder="folds10", fileVectors="vectors.txt", phraseLen = 200, lstmCells=100, hiddenNodes=400, dropout=0.3, patience=2, batchSize=65, epochs=100):
        self._tasks = tasks
