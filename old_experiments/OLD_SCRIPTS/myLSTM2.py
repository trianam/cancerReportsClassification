...
class MyLSTM:
    ...
    _tasks = ['sede1']
    _filesFolder = "./files94"
    _memmapFolder = "./memmapLSTM2"
    ...
    _fileVectors = _corpusFolder+"/vectors11.txt"
    
    _fileMemmapX = "./tmp2/X.dat"
    _fileMemmapYUn = {
        'sede1' : "./tmp2/yUnSede1.dat",
        'sede2' : "./tmp2/yUnSede2.dat",
        'sede12' : "./tmp2/yUnSede12.dat",
        'morfo1' : "./tmp2/yUnMorfo1.dat",
        'morfo2' : "./tmp2/yUnMorfo2.dat",
        'morfo12' : "./tmp2/yUnMorfo12.dat"
    }
    _fileMemmapY = {
        'sede1' : "./tmp2/ySede1.dat",
        'sede2' : "./tmp2/ySede2.dat",
        'sede12' : "./tmp2/ySede12.dat",
        'morfo1' : "./tmp2/yMorfo1.dat",
        'morfo2' : "./tmp2/yMorfo2.dat",
        'morfo12' : "./tmp2/yMorfo12.dat"
    }
