...
class MyLSTM:
    _filesFolder = "./filesFolds-LSTM4"
    _memmapFolder = "./memmapFolds-LSTM4"
    _tmpFolder = "./tmpFolds-LSTM4"
    ...
    def __init__(self, fold=0, tasks=['sede1', 'sede12', 'morfo1', 'morfo2'], corpusFolder="corpusLSTM_ICDO3", foldsFolder="folds10", fileVectors="vectors.txt", phraseLen = 100, hiddenNodes=400, dropout=0.3, patience=4, batchSize=65, epochs=100):
        self._tasks = tasks
