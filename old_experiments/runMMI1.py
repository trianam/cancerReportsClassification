    ...
    for featuresLayers in featuresLayersList:
        ...
        for fold in range(1):
            ...
            for task in ['sede1']:
                    ...
                    while True:
                        try:
                            ...
                            if tentatives < 10:
                                ...
                                notifier.sendMessage("MEMORY ERROR on runMMI1.py on sugaar1 finished", "start: "+startTime+"  -  end: "+endTime)
                                time.sleep(30)
                                raise err
                        else:
                            break
                ...
                notifier.sendMessage("cnn{}x{}-1hidd on sugaar1 partial".format(featuresLayers, featuresDim), "start: "+startPartTime+"  -  end: "+endPartTime)

endTime = str(datetime.datetime.now())
print("########################################### Finish ({})".format(endTime))
notifier.sendMessage("runMMI1 on sugaar1 finished", "start: "+startTime+"  -  end: "+endTime)
