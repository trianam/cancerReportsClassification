...
class MyLSTM:
    _filesFolder = "./filesFolds-LSTMconvolutional2"
    _memmapFolder = "./memmapFolds-LSTMconvolutional"
    ...
    def _createModel(self, outDim):
        ...
        model.add(Conv1D(filters=self._convFilters, kernel_size=2, strides=1, padding='valid', activation='relu', input_shape=(self._phraseLen, self._vecLen)))
